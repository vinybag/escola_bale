...
urlpatterns = [
    ...
    path('<int:pk>/maquiagem/', views.agendar_maquiagem, name='agendar_maquiagem'),
    path('<int:pk>/maquiagem/reservar/<int:horario_id>/', views.reservar_horario_maquiagem, name='reservar_horario_maquiagem'),
    path('<int:pk>/maquiagem/confirmar/<int:horario_id>/', views.confirmar_agendamento_maquiagem, name='confirmar_agendamento_maquiagem'),
    path('maquiagem/sucesso/<int:agendamento_id>/', views.agendamento_maquiagem_sucesso, name='agendamento_maquiagem_sucesso'),
